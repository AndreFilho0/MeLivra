        ...
        >
          <div class="overflow-y-auto py-5 px-3 h-full  dark:bg-gray-800">
            ...
            <ul class="space-y-2">
              <li>
                <a
                  :href="route('dashboard.buscarprofessor')"
                ...
                >
                  ...
                  <span class="ml-3">Buscar Professor</span>
                </a>
              </li>
              <li>
                <button
                ...
                <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                  ...
                  <li>
                    <a
                      :href="route('dashboard.reclamacao')"
                      class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                      >Reclamações</a
                    >
                  </li>
...
<script setup>
import {CurrencyDollarIcon , BookOpenIcon} from '@heroicons/vue/20/solid'
