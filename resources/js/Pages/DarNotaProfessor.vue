<template>
  ...
  <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
      ...
      <Link v-if="not" :href="route('dashboard')" type="button" class="relative  mt-10 block w-full rounded-lg border-2 border-dashed border-gray-300 p-12 text-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
